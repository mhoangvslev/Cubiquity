...
void EmptyLinkFunctionForGeneratedCode1Cubiquity() {}
	...
	IMPLEMENT_CLASS(ACubiquityColoredCubesVolume, 73929590);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	UFunction* Z_Construct_UFunction_ACubiquityColoredCubesVolume_pickFirstSolidVoxel()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("pickFirstSolidVoxel"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x54C20401, 65535, sizeof(CubiquityColoredCubesVolume_eventpickFirstSolidVoxel_Parms));
			UProperty* NewProp_hitLocation = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("hitLocation"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(hitLocation, CubiquityColoredCubesVolume_eventpickFirstSolidVoxel_Parms), 0x0010000000000180, Z_Construct_UScriptStruct_FVector());
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(success, CubiquityColoredCubesVolume_eventpickFirstSolidVoxel_Parms, bool);
			UProperty* NewProp_success = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("success"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(success, CubiquityColoredCubesVolume_eventpickFirstSolidVoxel_Parms), 0x0010000000000180, CPP_BOOL_PROPERTY_BITMASK(success, CubiquityColoredCubesVolume_eventpickFirstSolidVoxel_Parms), sizeof(bool), true);
			...
			UProperty* NewProp_localStartPosition = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("localStartPosition"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(localStartPosition, CubiquityColoredCubesVolume_eventpickFirstSolidVoxel_Parms), 0x0010000008000182, Z_Construct_UScriptStruct_FVector());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
			...
			MetaData->SetValue(NewProp_localDirection, TEXT("NativeConst"), TEXT(""));
			MetaData->SetValue(NewProp_localStartPosition, TEXT("NativeConst"), TEXT(""));
#endif
		}
		return ReturnFunction;
	}
	UFunction* Z_Construct_UFunction_ACubiquityColoredCubesVolume_pickLastEmptyVoxel()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("pickLastEmptyVoxel"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x54C20401, 65535, sizeof(CubiquityColoredCubesVolume_eventpickLastEmptyVoxel_Parms));
			UProperty* NewProp_hitLocation = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("hitLocation"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(hitLocation, CubiquityColoredCubesVolume_eventpickLastEmptyVoxel_Parms), 0x0010000000000180, Z_Construct_UScriptStruct_FVector());
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(success, CubiquityColoredCubesVolume_eventpickLastEmptyVoxel_Parms, bool);
			UProperty* NewProp_success = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("success"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(success, CubiquityColoredCubesVolume_eventpickLastEmptyVoxel_Parms), 0x0010000000000180, CPP_BOOL_PROPERTY_BITMASK(success, CubiquityColoredCubesVolume_eventpickLastEmptyVoxel_Parms), sizeof(bool), true);
			UProperty* NewProp_localDirection = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("localDirection"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(localDirection, CubiquityColoredCubesVolume_eventpickLastEmptyVoxel_Parms), 0x0010000008000182, Z_Construct_UScriptStruct_FVector());
			UProperty* NewProp_localStartPosition = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("localStartPosition"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(localStartPosition, CubiquityColoredCubesVolume_eventpickLastEmptyVoxel_Parms), 0x0010000008000182, Z_Construct_UScriptStruct_FVector());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UClass* Z_Construct_UClass_ACubiquityColoredCubesVolume()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_ACubiquityColoredCubesVolume_pickFirstSolidVoxel(), "pickFirstSolidVoxel"); // 164860207
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_ACubiquityColoredCubesVolume_pickLastEmptyVoxel(), "pickLastEmptyVoxel"); // 3492608133
